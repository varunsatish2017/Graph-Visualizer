 ...
 *
 * Props:
 *   traversalList  – array of node IDs in traversal order ([] when idle)
 ...
 */
export default function TraversalBar({ traversalList, currentStep, onStepChange, mode }) {
              ...
              <button
                ...
                style={{
                  ...
                  ...(idx === currentStep ? {
                    ...
                    border: `1px solid ${theme.pillActiveBorder}`,
                    color: '#fff',
